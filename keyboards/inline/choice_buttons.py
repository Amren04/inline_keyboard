...
buy_alarm = InlineKeyboardButton(text="Alarm", callback_data=buy_callback.new(item_name="alarm", quantity=1))
choice.insert(buy_alarm)

buy_clock = InlineKeyboardButton(text="Clock", callback_data=buy_callback.new(item_name="clock", quantity=1))
